...
public class CamiciaC {
    ...
    // un costruttore della classe, omonimo a essa. potrei crearne altri a seconda delle esigenze
    public CamiciaC(int camiciaID, String descrizione, char codiceColore, int disponibili, int quantita, double prezzo) {
    ...
    // ricreo il costruttore default per eventuali istanze create senza passaggio paramentri da costruttore
    public CamiciaC(){
    }
    ...
    public int getCamiciaID() {
        return this.camiciaID; // non occorrebbe this perchè non c'è una variabile locale omonima
    }
